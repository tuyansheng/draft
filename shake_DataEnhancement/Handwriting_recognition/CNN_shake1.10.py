...
if __name__ == "__main__":
    ...
    print("Starting training ShakeAug model...")
    for epoch in range(num_epochs):
        ...
        print(f"Epoch {epoch + 1:2d} | Test(ShakeAug): {acc_aug * 100:.2f}%")

    print("Starting training Rotation model...")
    for epoch in range(num_epochs):
        ...
        acc_rot = accuracy(model_rotation, device, test_loader)
        print(f"Epoch {epoch + 1:2d} | Test(Rotation): {acc_rot * 100:.2f}%")
