...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_physical_variable_label_path', type=str, default = './Label/all_params_cwt_window_train.csv', help='train physical parameters and label path')
    parser.add_argument('--test_data_path', type=str, default = './Test', help='test dataset path')
    parser.add_argument('--test_physical_variable_label_path', type=str, default = './Label/all_params_cwt_window_test.csv', help=' test physical parameters and label path')
    parser.add_argument('--return_phy_vars', type=bool, default = True, help=' True: (img, label, phy_vsrs), False: (img, label)')
    ...
    # model paras
    parser.add_argument('--img_size', type=int, nargs = 2, default = (224, 224), help='image size for PEVNet (height width)')
