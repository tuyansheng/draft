...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_mode', type=str, default='fair',choices=['fair', 'expand'],
                    help='fair: all methods use N samples; expand: allow dataset expansion')
    # shake parameters
    parser.add_argument('--shake_k', type=int, default=1, help='number of recipes (K)')
    parser.add_argument('--shake_N', type=int, default=2, help='iterations N per recipe')
    parser.add_argument('--shake_beta', type=float, default=0.03)
    parser.add_argument('--shake_alpha', type=float, default=0.2)
    parser.add_argument('--shake_cell_h', type=int, default=8)
    parser.add_argument('--shake_cell_w', type=int, default=8)
    parser.add_argument('--shake_p_apply', type=float, default=1.0)
    parser.add_argument('--shake_offset', type=str, default='random_each_iter',choices=['random', 'random_each_iter', 'none'])
    parser.add_argument('--shake_dynamic', type=str2bool, default=True)
    ...
    parser.add_argument('--img_size', type=int, default=224, help='imagenet input crop size (e.g., 224). MNIST/CIFAR are fixed (28/32).')
    ...
    args.aug_mode = args.aug_mode.lower()

    # if cuda not available, force cpu
