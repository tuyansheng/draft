...
from data_loader.data_loader_cavitation import DatasetLoader
...
class Experiment_Main(Experiment_Basic):
    ...
    def _get_data(self, flag):
        if flag.upper() == "TRAIN":
            ...
            dataset = DatasetLoader(self.args.train_data_path, self.args.train_physical_variable_label_path, transform = transform, return_phy_vars = self.args.return_phy_vars)
            ...
            dataset = DatasetLoader(self.args.test_data_path, self.args.test_physical_variable_label_path, transform = transform, return_phy_vars = self.args.return_phy_vars)
        else:
