...
class Experiment_Main(Experiment_Basic):
    ...
    def _get_data(self, flag):
        ...
        dataloader = torch.utils.data.DataLoader(dataset, batch_size = self.args.batch_size, shuffle = is_train, num_workers = self.args.num_workers, pin_memory = True, drop_last = is_train)
    ...
    def train(self, setting):
        ...
        best_ckpt = os.path.join(path, "checkpoint_ealy_stopping_{metrics_test['accuracy']}.pth")
