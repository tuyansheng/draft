...
def swin_tiny_patch4_window7_224(num_classes: int, **kwargs):
    model = SwimTransformer(downsapmle_size = 4, window_size = 7, embed_dim = 96, depths = (2,2,6,2), num_heads = (3,6,12,24), num_classes = num_classes)
    print('swin_tiny_patch4_window7_224')
    return model

def swin_small_patch4_window7_224(num_classes: int, **kwargs):
    model = SwimTransformer(downsapmle_size = 4, window_size = 7, embed_dim = 96, depths = (2,2,18,2), num_heads = (3,6,12,24), num_classes = num_classes)
    print('swin_small_patch4_window7_224')
    return model

def swin_base_patch4_window7_224(num_classes: int, **kwargs):
    model = SwimTransformer(downsapmle_size = 4, window_size = 7, embed_dim = 128, depths = (2,2,18,2), num_heads = (4,8,16,32), num_classes = num_classes)
    print('swin_base_patch4_window7_224')
    return model

def swin_base_patch4_window12_384(num_classes: int, **kwargs):
    model = SwimTransformer(downsapmle_size = 4, window_size = 12, embed_dim = 128, depths = (2,2,18,2), num_heads = (4,8,16,32), num_classes = num_classes)
